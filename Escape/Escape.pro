...
unrealRootPath=/mnt/8bfd2b1d-bf30-482b-ab7c-0967e1ed6a46/Apps/UnrealEngine
EscapeRootPath=/home/tyler/ReposLink/unrealCourse/Escape

gameProjectFile=/home/tyler/ReposLink/unrealCourse/Escape/Escape.uproject
...
include(EscapeSource.pri)
include(EscapeHeader.pri)
include(EscapeConfig.pri)
include(EscapeIncludes.pri)
include(EscapeDefines.pri)

Escape-Linux-Debug.commands = $$build Escape Linux Debug  -project="\"$$gameProjectFile\"" $$args
Escape-Linux-DebugGame.commands = $$build Escape Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Escape-Linux-Shipping.commands = $$build Escape Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Escape-Linux-Test.commands = $$build Escape Linux Test  -project="\"$$gameProjectFile\"" $$args
Escape.commands = $$build Escape Linux Development  -project="\"$$gameProjectFile\"" $$args

EscapeEditor-Linux-Debug.commands = $$build EscapeEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
EscapeEditor-Linux-DebugGame.commands = $$build EscapeEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EscapeEditor-Linux-Shipping.commands = $$build EscapeEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EscapeEditor-Linux-Test.commands = $$build EscapeEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
EscapeEditor.commands = $$build EscapeEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	Escape-Linux-Debug \
	Escape-Linux-DebugGame \
	Escape-Linux-Shipping \
	Escape-Linux-Test \
	Escape \
	EscapeEditor-Linux-Debug \
	EscapeEditor-Linux-DebugGame \
	EscapeEditor-Linux-Shipping \
	EscapeEditor-Linux-Test \
	EscapeEditor \
